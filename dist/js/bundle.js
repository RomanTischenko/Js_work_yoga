...
function form() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    newPromise().then(function () {
      return statusMessage.textContent = status.loaded;
    }).then(function () {
      return statusMessage.textContent = status.end;
    }).catch(function () {
      return statusMessage.textContent = status.error;
    });
  });
}
module.exports = form;
...
function modal() {
  var btnTab = document.querySelectorAll('.description-btn'),
